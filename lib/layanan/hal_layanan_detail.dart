...
class HalLayanan extends StatefulWidget {
  const HalLayanan({super.key});

  @override
  State<HalLayanan> createState() => _HalLayananState();
}
        ...
        child: InkWell(
          onTap: () async {
            final Uri url = Uri.parse(
                'https://ppid.kendalkab.go.id/layanan/unduh-formulir/');
            if (!await launchUrl(
              url,
              ...
              children: [
                ...
                Column(
                  ...
                  children: <Widget>[
                    ...
                    const Text(
                      'Tata Cara Mendapatkan Informasi', //IBADAH
                      style: TextStyle(
                        fontSize: 18,
                        fontWeight: FontWeight.bold,
                        color: Colors.black,
    ...
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: () async {
            final Uri url = Uri.parse(
                'https://ppid.kendalkab.go.id/tata-cara-pengajuan-keberatan/');
            if (!await launchUrl(
              url,
              mode: LaunchMode.externalApplication,
            )) {
              ...
              children: [
                ...
                Column(
                  ...
                  children: <Widget>[
                    ...
                    const Text(
                      'Tata Cara Pengajuan Keberatan', //IBADAH
                      style: TextStyle(
                        fontSize: 18,
                        fontWeight: FontWeight.bold,
                        color: Colors.black,
  ...
  Widget _informasilayanan3() {
    ...
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: () {
            Navigator.pushNamed(context, '/HalLayananAduan');
          },
          child: Container(
            decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(10),
